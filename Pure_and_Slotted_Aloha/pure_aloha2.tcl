#This is the implementation of pure aloha with different options.


if { $argc != 1 } {
        puts stderr {usage: ns filename.tcl [basic basic_tracing poisson]}
        exit 1
}
set test_ $argv
...
set outfile [open pure_aloha2.tr w]
